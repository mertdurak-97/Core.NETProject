...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20221224210954_withReRenderEntity")]
    partial class withReRenderEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityLayer.Message", b =>
                {
                    b.HasOne("EntityLayer.AppUser", "ReceiverUser")
                        .WithMany("UserReceiver")
                        .HasForeignKey("ReceiverID")
                        .IsRequired();

                    b.HasOne("EntityLayer.AppUser", "SenderUser")
                        .WithMany("UserSender")
